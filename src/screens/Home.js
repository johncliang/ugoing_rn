        ...
        <View style={styles.mainContainer}>
            <View style={GlobalStyles.topSection}>
                    ...
                    >
                        ...
                        <View style={[styles.columnContainer, {marginBottom: 23}]}>
                            <Image
                                style={{ height: 172, width: 172, marginTop: 23 }}
                    ...
                    >
                        ...
                        <View style={styles.columnContainer}>
                            <Text
                                style={[
                                    GlobalStyles.bodyText,
                                    { textAlign: "left", paddingHorizontal: 17, fontSize: 18, paddingTop: 28 },
                                ]}
                            >
                                Does it get any{"\n"}
                                better?
                ...
                <View style={[styles.columnContainer, {justifyContent: 'center', backgroundColor: '#FFFFFF', borderTopWidth: 1, borderColor: '#D5D5D5'}]}>
                    <TouchableOpacity onPress = {() => navigation.navigate("About")} style={{width: '35%', paddingTop: 17, paddingBottom: 40 }}>
                        <Text style={[styles.footerText, {textAlign: "center"}]}>
                            About
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress = {() => navigation.navigate("TOS")} style={{width: '30%', paddingTop: 17, paddingBottom: 40 }}>
                        <Text style={[styles.footerText, {textAlign: "center"}]}>
                            Terms Of Use
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress = {() => navigation.navigate("PrivacyPolicy")} style={{width: '35%', paddingTop: 17, paddingBottom: 40 }}>
                        <Text style={[styles.footerText, {textAlign: "center"}]}>
                            Privacy Policy
                        </Text>
                    </TouchableOpacity>

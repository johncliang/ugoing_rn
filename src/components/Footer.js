				...
				<View
					style={[
						...
						styles.footerContainer,
						{
							backgroundColor: this.props.homepage
								? GlobalColors.darkGrey
								: "white" /*borderWidth: 1, borderColor: this.props.homepage == true ? GlobalColors.darkGrey: GlobalColors.standardRed, borderTopWidth: 0, borderLeftColor: 'white', borderRightColor: 'white', borderBottomColor:'white'*/,
						},
					]}
				>
					{this.props.publish && (
					...
					>
						...
						<Text
							style={[
								GlobalStyles.bodyText,
								{
									marginRight: this.props.homepage ? 0 : "1.5625rem",
									textAlign: "center",
									color: "white",
									fontSize: "0.75rem",
								},
